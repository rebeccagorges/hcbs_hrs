...
**January 2017
/*  ***************DO NOT USE*****************
We don't need to use this again! The newer sheet with target population filled in
should be the only excel file we need to merge with the master list now

Many waivers listed in the master list - HCBS_Waivers_all.xlsx (dated October 2016)
are missing from the list with the target population data - State_Plans_Waivers_rcd_11_22_16.xlsx
This do file starts with the target population file and adds in the 
waivers that are missing from the master list so we could do additional data collection
in an effort to fill in target population for all waivers in the master list

Created file waivers_merged_rg_20170215.xlsx which Lauren then filled in - during February-March 2017
*/
